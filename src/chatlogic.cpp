...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    //std::cout << "ChatBot created from ChatLogic::LoadAnswerGraphFromFile() \n";
    ChatBot chatBot("../images/chatbot.png");

    //std::cout << "ChatBot SetChatLogicHandle \n";
    chatBot.SetChatLogicHandle(this);
    //std::cout << "ChatBot SetRootNode \n";
    chatBot.SetRootNode(rootNode);
    //std::cout << "RootNode -> MoveChatBotHere\n"; 
    rootNode->MoveChatbotHere(std::move(chatBot));

    // std::cout << "RootNode -> MoveChatBotHere end\n"; 
...
void ChatLogic::SetChatbotHandle(ChatBot *chatb)
{
...
void ChatLogic::SendMessageToChatbot(std::string message)
{
    ...
    //std::cout << "ChatLogic::SendMessageToCahtBot end \n";
}
